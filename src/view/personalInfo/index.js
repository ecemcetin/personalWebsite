      ...
      <div className="w-full mb-6 lg:mb-0  mx-auto  relative bg-white text-center dark:bg-[#111111] px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0 ">
        ...
        <div className="pt-[100px] pb-8">
          ...
          <div className="flex justify-center space-x-3">
            <a>
              <span className={`${styles.socialMedias}`}>a</span>
              <span className={`${styles.socialMedias}`}>a</span>
              <span className={`${styles.socialMedias}`}>a</span>
              <span className={`${styles.socialMedias}`}>a</span>
            </a>
          ...
          <a className="inline-flex items-center mx-auto bg-gradient-to-r from-[#FA5252] to-[#DD2476] duration-200 transition ease-linear hover:bg-gradient-to-l from-[#DD2476]  to-[#fa5252ef] px-8 py-3 text-lg text-white rounded-[35px] mt-6">
            ecem
          </a>
        </div>
      </div>
